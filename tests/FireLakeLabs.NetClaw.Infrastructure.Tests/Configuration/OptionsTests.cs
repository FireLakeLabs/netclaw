...
namespace FireLakeLabs.NetClaw.Infrastructure.Tests.Configuration;
...
public sealed class OptionsTests
{
    ...
    public void AgentRuntimeOptions_ParseConfiguredProvider()
    {
        ...
        Assert.Equal(FireLakeLabs.NetClaw.Domain.Enums.AgentProviderKind.Copilot, options.GetDefaultProvider());
    }
