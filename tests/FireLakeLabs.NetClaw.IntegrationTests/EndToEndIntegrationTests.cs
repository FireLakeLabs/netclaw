...
public sealed class EndToEndIntegrationTests
{
        ...
        try
        {
            using IHost host = CreateHost(projectRoot, services =>
            {
                ...
                TerminalChannel terminalChannel = new(
                    new FireLakeLabs.NetClaw.Infrastructure.Configuration.TerminalChannelOptions
                    {
                        Enabled = true,
                        ChatJid = "team@jid",
                        Sender = "sender-1",
        ...
        try
        {
            using IHost host = CreateHost(projectRoot, services =>
            {
                ...
                SlackChannel slackChannel = new(
                    new FireLakeLabs.NetClaw.Infrastructure.Configuration.SlackChannelOptions
                    {
                        Enabled = true,
                        BotToken = "xoxb-test",
                        AppToken = "xapp-test",
                    ...
                    slackClient,
                    FireLakeLabs.NetClaw.Infrastructure.Configuration.StorageOptions.Create(projectRoot));
    ...
    {
        IHostBuilder builder = FireLakeLabs.NetClaw.Host.Program.CreateHostBuilder([])
