...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddNetClawHostServices(this IServiceCollection services, IConfiguration configuration, IHostEnvironment environment)
    {
        ...
        services.AddSingleton<IGroupRepository, FileGroupRepository>();
        services.AddSingleton<ISessionRepository, FileSessionRepository>();
        services.AddSingleton<ITaskRepository, FileTaskRepository>();
        services.AddSingleton<IRouterStateRepository, FileRouterStateRepository>();
        services.AddSingleton<IAgentEventRepository, FileAgentEventRepository>();
        services.AddSingleton<IFileAttachmentRepository, FileAttachmentRepository>();
